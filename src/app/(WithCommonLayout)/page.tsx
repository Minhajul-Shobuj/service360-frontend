        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row gap-10 items-center">
          ...
          <div className="flex-1 min-w-[300px]">
            ...
            <p className="text-gray-600 mb-6 text-lg">
              We won&apos;t let your cleaning and maintenance problems get to
              you. Besides providing quality home services in Bangladesh, our
              skilled pros can also tidy up your garden or clean your home or
              office anywhere in the country. Here are some of the main
              locations we serve:
            </p>
